...
woff = path + "/webfonts/woff/style_154926.woff";
if (http) {
...
//test for eot
eot = path + "/webfonts/eot/style_154926.eot";
if (http) {
	xmlhttp=new XMLHttpRequest();
}
else {
...
//test for svg
svg = path + "/webfonts/svg/style_154926.svg";
if (http) {
	xmlhttp=new XMLHttpRequest();
}
else {
...
//test for css
css = path + "/webfonts/datacss/Webfonts.css";
if (http) {
	xmlhttp=new XMLHttpRequest();
}
else {
...
woff = path + "/webfonts/woff/style_154928.woff";
if (http) {
	xmlhttp=new XMLHttpRequest();
}
else {
...
if(xmlhttp.status == 200) {
	...
	addtoDiv('Woff_result','error',"WOFF File: " +woff+ " is inaccessable.  Check the file permissions and the MIME types");
//test for eot
eot = path + "/webfonts/eot/style_154928.eot";
if (http) {
	xmlhttp=new XMLHttpRequest();
}
else {
...
if(xmlhttp.status == 200) {
	...
	addtoDiv('eot_result','error',"EOT File: " +eot+" is inaccessable.  Check the file permissions and the MIME types");
//test for svg
svg = path + "/webfonts/svg/style_154928.svg";
if (http) {
	xmlhttp=new XMLHttpRequest();
}
else {
